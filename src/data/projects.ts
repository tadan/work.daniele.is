...
export const projects: Project[] = [
    ...
    },
    {
        ...
        challenge: `In 2018, Sweden's largest logistics operator PostNord faced a critical operational crisis that threatened their market position. Delivery precision had plummeted to just 73%, with missed deliveries severely impacting customer experience and brand perception reaching all-time lows. The company desperately needed a ground-level solution to transform their terminal operations, rebuild customer confidence, and prove that meaningful change was possible across one of Sweden's largest distribution networks. Revenue streams were under threat, and without immediate intervention, PostNord risked losing their competitive edge in the logistics market.`,
        solution: `The SWAN Dashboard emerged as a transformative real-time performance management system, installed across all PostNord terminals in Sweden. Born as a pre-COVID prototype, this React/Redux-based application provided delivery teams with immediate visibility into critical KPIs, enabling instant corrective action. The solution featured intuitive data visualization, real-time delivery tracking, and performance metrics that empowered drivers and supervisors to make informed decisions on the terminal floor. Through continuous iteration based on Customer Experience feedback, the dashboard evolved into an essential operational tool.`,
        role: `I served as Front End Developer and Designer of the application based on React/Redux. My responsibilities included creating the design system, wireframes and mockups in Figma, as well as conducting remote user testing to evaluate and iterate the app features.`,
        year: '2020–2022',
