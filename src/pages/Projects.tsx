    ...
    const renderProjectList = (projectList: typeof projects, title: string) => (
        <div className='mb-8'>
            ...
            <div className='py-4 px-1'>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4 text-sm font-medium text-muted-foreground border-b pb-2 mb-4'>
                ...
                {projectList.map((project, index) => {
                    ...
                    return (
                        <div
                            key={project.title}
                            className='grid grid-cols-1 md:grid-cols-4 gap-2 py-4 border-b border-black hover:bg-muted/30 cursor-pointer transition-colors'
                            onClick={() => {
        ...
        <div className='min-h-screen w-full pt-5'>
            ...
            <section className='py-4 bg-gray-100'>
                <div className='max-w-7xl mx-auto'>
                    <h1 className='text-s uppercase mb-12'>List of Work</h1>
